{ pkgs, config, ... }:
{
    ...
    (self: super: {
      decklink-sdk =
        super.runCommand "decklink-sdk"
          ...
          '';
      blackmagic-desktop-video = super.blackmagic-desktop-video.overrideAttrs (
        {
          postInstall ? "",
          buildInputs ? [ ],
          ...
  ...
  hardware.hwsCapture = {
    enable = true;
    #    package = pkgs.mkHwsVendorModule config.boot.kernelPackages;
  };
  image.modules.iso = {
    # EFI booting
